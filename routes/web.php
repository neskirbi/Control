 ...
 */
 ...
 Route::resource('usuarios', 'App\Http\Controllers\SuperUsuario\UsuarioController');

 Route::post('LoginMD', 'App\Http\Controllers\SuperUsuario\LoginController@LoginMD');
 /**
